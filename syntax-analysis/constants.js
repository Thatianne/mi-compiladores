...
const RELATIONAL_OPERATOR_ASSIGNMENT = 'relationalOperatorAssignment';
const RELATIONAL_OPERATOR_BIGGER = 'relationalOperatorBigger';
const RELATIONAL_OPERATOR_BIGGER_OR_EQUALS = 'relationalOperatorBiggerOrEquals';
const RELATIONAL_OPERATOR_EQUALS = 'relationalOperatorEquals';
const RELATIONAL_OPERATOR_NOT_EQUALS = 'relationalOperatorNotEquals';
const RELATIONAL_OPERATOR_SMALLER = 'relationalOperatorSmaller';
const RELATIONAL_OPERATOR_SMALLER_OR_EQUALS = 'relationalOperatorSmallerOrEquals';
const ARITHMETIC_OPERATOR_MULTIPLICATION = 'arithmeticOperatorMultiplication';
const ARITHMETIC_OPERATOR_DIVISION = 'arithmeticOperatorDivision';
const ARITHMETIC_OPERATOR_SUM = 'arithmeticOperatorSum';
const ARITHMETIC_OPERATOR_INCREMENT = 'arithmeticOperatorIncrement';
const ARITHMETIC_OPERATOR_MINUS = 'arithmeticOperatorMinus';
const ARITHMETIC_OPERATOR_DECREMENT = 'arithmeticOperatorDecrement';
const NUMBER = 'number';
...
module.exports = {
  ...
  RELATIONAL_OPERATOR_ASSIGNMENT,
  RELATIONAL_OPERATOR_BIGGER,
  RELATIONAL_OPERATOR_BIGGER_OR_EQUALS,
  RELATIONAL_OPERATOR_EQUALS,
  RELATIONAL_OPERATOR_NOT_EQUALS,
  RELATIONAL_OPERATOR_SMALLER,
  RELATIONAL_OPERATOR_SMALLER_OR_EQUALS,
